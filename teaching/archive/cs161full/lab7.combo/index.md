...
The toString() method has been implemented, according to the format,
in the Combination class. For instance, a comma should not be
generated after the last number.

setValue() has been implemented, and will only operate on inputs
within the allowed range.

The equals() method is properly implemented in Combination.
Returns true if the number sequence that is stored in a
given Combination object matches this combination sequence.

The 3-argument constructor is implemented for ComboGuesser.
